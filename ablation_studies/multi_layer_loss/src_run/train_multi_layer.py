...
import sys
sys.path.insert(0, './ablation_studies/multi_layer_loss')

from trainer_multi_layer import EfficientADTrainer
from models.torch_model import EfficientAdModelSize
...
save_path = Path("ablation_studies/multi_layer_loss/results") / dataset_name / f"{category}{model_size_suffix}_multi_layer" / "model.pth"
save_path.parent.mkdir(parents=True, exist_ok=True)
trainer.save_model(save_path)
print(f"Multi-layer model saved to: {save_path}")
