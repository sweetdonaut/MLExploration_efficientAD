...
def create_visualization(image_path, map_st, map_stae, anomaly_map, gt_mask_path=None):
...
category = "grid"
data_root = Path("./datasets/mvtec")
model_path = Path("results/EfficientAd/MVTec/grid/v0/weights/lightning/model.ckpt")
...
output_dir = Path("results_cli/EfficientAd/MVTec") / category / "images/test"
