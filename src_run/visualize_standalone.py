...
def create_visualization(image_path, map_st, map_stae, anomaly_map, gt_mask_path=None, vis_size=(256, 256)):
...
parser = argparse.ArgumentParser(description='Visualize EfficientAD model')
